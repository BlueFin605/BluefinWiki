...
vi.mock('react-router-dom', async () => {
  ...
  return {
    ...
    useBeforeUnload: vi.fn((callback) => {
      ...
      (global as { __beforeUnloadCallback?: unknown }).__beforeUnloadCallback = callback;
    }),
...
describe('useUnsavedChanges', () => {
  beforeEach(() => {
    vi.clearAllMocks();
    delete (global as { __beforeUnloadCallback?: unknown }).__beforeUnloadCallback;
  ...
  describe('Basic Functionality', () => {
    it('should not warn when isDirty is false', () => {
      ...
      expect((global as { __beforeUnloadCallback?: unknown }).__beforeUnloadCallback).toBeDefined();
    });
  ...
  describe('Browser Navigation Warning', () => {
    it('should return message on beforeunload when dirty', () => {
      ...
      const callback = (global as { __beforeUnloadCallback?: (event: BeforeUnloadEvent) => string | undefined }).__beforeUnloadCallback;
  ...
  describe('State Changes', () => {
    it('should update warning when isDirty changes', () => {
      ...
      let callback = (global as { __beforeUnloadCallback?: (event: BeforeUnloadEvent) => string | undefined }).__beforeUnloadCallback;
      if (callback) {
      ...
      callback = (global as { __beforeUnloadCallback?: (event: BeforeUnloadEvent) => string | undefined }).__beforeUnloadCallback;
      if (callback) {
