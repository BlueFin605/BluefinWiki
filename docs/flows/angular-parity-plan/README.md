...
| 8 | 6 | 0/6 | not started |
| **Total** | **73** | **67/73** | corrected 2026-09-16: the running total had drifted from the per-phase row sum since at least the Phase 5 close-out; recomputed directly from this table's own Done column |
